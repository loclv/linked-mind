...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("linked_mind", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "linked_mind" is the name you will use in your source code to
                // import this module (e.g. `@import("linked_mind")`). The name is
